...
contract SimpleStorage {
    ...
    function store(uint256 _favouriteNumber) public virtual{ // function declaration
    ...
    function retrieve() public view returns(uint256){ // gas because it reads from pure function
